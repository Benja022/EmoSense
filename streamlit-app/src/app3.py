...
svm_model = joblib.load('/workspaces/EmoSense/streamlit-app/models/svm_model.pkl')
vectorizer = joblib.load('/workspaces/EmoSense/streamlit-app/models/tfidf_vectorizer.pkl')
label_encoder = joblib.load('/workspaces/EmoSense/streamlit-app/models/label_encoder.pkl')
model_audio_mlp = joblib.load('/workspaces/EmoSense/streamlit-app/models/model_emotions_audio_mlp.pkl')
label_encoder_audio_mlp = joblib.load('/workspaces/EmoSense/streamlit-app/models/label_encoder_audio_mlp.pkl')
...
set_background("/workspaces/EmoSense/streamlit-app/src/background4.png")
...
show_logo("/workspaces/EmoSense/streamlit-app/src/logo.png")
